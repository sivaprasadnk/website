...
import 'package:spnk/views/android/projects/quizApp/quiz.app.title.text.dart';
...
class QuizAppItemMobile extends StatelessWidget {
  const QuizAppItemMobile({Key? key}) : super(key: key);
