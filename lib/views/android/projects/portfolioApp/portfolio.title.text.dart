...
class PortfolioTitleTextMobile extends StatelessWidget {
  const PortfolioTitleTextMobile({Key? key}) : super(key: key);
...
class VisitLinkContainer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        // height: 50,
        margin: const EdgeInsets.only(left: 20, top: 4, right: 1),
        decoration: BoxDecoration(
          color: Colors.black,
